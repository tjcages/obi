    ...
    <div ref={triggerRef}>
      {showAsDate && dateLabel ? (
        ...
        <button
          type="button"
          onClick={() => { setOpen(!open); setShowCal(false); }}
          className="rounded-md p-1 text-foreground-300 transition-colors hover:bg-blue-50 hover:text-blue-500 dark:hover:bg-blue-950/30 dark:hover:text-blue-400"
          title="Set date"
        >
